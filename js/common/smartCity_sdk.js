(function(){
	...
	$.extend( Plugin.prototype , {
		...
		scanQRCode : function( callback ){														/*扫码*/
			return this.callApiCenter( 'scanQRCode', null , callback );
		}
	} );
	...
	window.scanQRCode = function( json ){
		Plugin.prototype.getClient.call( SmartCity, 'scanQRCode', json );
	};
})();
